...
class WD_CELL_VERTICAL_ALIGNMENT(XmlEnumeration):
    ...
    Example::
        ...
        from daijdocx.enum.table import WD_ALIGN_VERTICAL
...
class WD_ROW_HEIGHT_RULE(XmlEnumeration):
    ...
    Example::
        ...
        from daijdocx.enum.table import WD_ROW_HEIGHT_RULE
...
class WD_TABLE_ALIGNMENT(XmlEnumeration):
    ...
    Example::
        ...
        from daijdocx.enum.table import WD_TABLE_ALIGNMENT
...
class WD_TABLE_DIRECTION(Enumeration):
    ...
    Example::
        ...
        from daijdocx.enum.table import WD_TABLE_DIRECTION
